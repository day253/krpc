...
func (p *AudioPredictRequest) ReadField3(iprot thrift.TProtocol) error {
	p.Audio = NewAudio()
	if err := p.Audio.Read(iprot); err != nil {
		return err
	}
	return nil
}
...
type AudioPredictorClient struct {
	c thrift.TClient
}

func NewAudioPredictorClientFactory(t thrift.TTransport, f thrift.TProtocolFactory) *AudioPredictorClient {
	return &AudioPredictorClient{
		c: thrift.NewTStandardClient(f.GetProtocol(t), f.GetProtocol(t)),
	}
}

func NewAudioPredictorClientProtocol(t thrift.TTransport, iprot thrift.TProtocol, oprot thrift.TProtocol) *AudioPredictorClient {
	return &AudioPredictorClient{
		c: thrift.NewTStandardClient(iprot, oprot),
	}
}

func NewAudioPredictorClient(c thrift.TClient) *AudioPredictorClient {
	return &AudioPredictorClient{
		c: c,
	}
}

func (p *AudioPredictorClient) Client_() thrift.TClient {
	return p.c
}

func (p *AudioPredictorClient) Predict(ctx context.Context, request *AudioPredictRequest) (r *AudioPredictResult_, err error) {
	var _args AudioPredictorPredictArgs
	_args.Request = request
	var _result AudioPredictorPredictResult
	if err = p.Client_().Call(ctx, "predict", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
func (p *AudioPredictorClient) Health(ctx context.Context) (r bool, err error) {
	var _args AudioPredictorHealthArgs
	var _result AudioPredictorHealthResult
...
type AudioPredictorProcessor struct {
	processorMap map[string]thrift.TProcessorFunction
	handler      AudioPredictor
}

func (p *AudioPredictorProcessor) AddToProcessorMap(key string, processor thrift.TProcessorFunction) {
	p.processorMap[key] = processor
}

func (p *AudioPredictorProcessor) GetProcessorFunction(key string) (processor thrift.TProcessorFunction, ok bool) {
	processor, ok = p.processorMap[key]
	return processor, ok
}

func (p *AudioPredictorProcessor) ProcessorMap() map[string]thrift.TProcessorFunction {
	return p.processorMap
}

func NewAudioPredictorProcessor(handler AudioPredictor) *AudioPredictorProcessor {
	self := &AudioPredictorProcessor{handler: handler, processorMap: make(map[string]thrift.TProcessorFunction)}
	self.AddToProcessorMap("predict", &audioPredictorProcessorPredict{handler: handler})
	self.AddToProcessorMap("health", &audioPredictorProcessorHealth{handler: handler})
	return self
}
func (p *AudioPredictorProcessor) Process(ctx context.Context, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
...
type audioPredictorProcessorPredict struct {
	handler AudioPredictor
}

func (p *audioPredictorProcessorPredict) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := AudioPredictorPredictArgs{}
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := AudioPredictorPredictResult{}
	var retval *AudioPredictResult_
...
type audioPredictorProcessorHealth struct {
	handler AudioPredictor
}

func (p *audioPredictorProcessorHealth) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := AudioPredictorHealthArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := AudioPredictorHealthResult{}
	var retval bool
...
func (p *AudioPredictorPredictArgs) ReadField1(iprot thrift.TProtocol) error {
	p.Request = NewAudioPredictRequest()
...
func (p *AudioPredictorPredictResult) ReadField0(iprot thrift.TProtocol) error {
	p.Success = NewAudioPredictResult_()
